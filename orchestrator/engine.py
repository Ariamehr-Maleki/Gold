...
class Orchestrator:
    ...
    def _resolve_country_ids(self):
        ...
        def find_country(name):
            ...
            for c in country_data:
                # Adapting to your country code json structure
        ...
        if origin_data:
             self.config["common_params"]["your_country_id"] = origin_data.get("code")
    ...
    def _extract_competitors_from_trademap_output(self, json_path: str) -> List[str]:
        """
        Reads TradeMap raw snapshots to find top 2 suppliers.
        """
        found_ids = []
        try:
